<?php
    ...
    if (!isset($_SESSION['userType']) || $_SESSION['userType'] != "manager") {
        //Only managers should have access to adding/removing products
...
<body>
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        if (isset($_SESSION['userType'])) {
                            ...
                            if ($_SESSION['userType'] == "manager") {
                                ...
                                echo' <a class="dropdown-item active" href="productListing.php">Update Inventory / Delete Product<span class="sr-only">(current)</span></a>
                                <div class="dropdown-divider"></div>';
    ...
    <div class="jumbotron jumbotron-fluid musicJumbotron">
        <div class="container">
            <h1 class="jumboHeading">Admin: Inventory Management</h1>
            <h2 class="jumboTagline">Update Inventory / Delete a Product</h2>
        </div>
    </div>
    <div class="container">
