<?php  
    ...
    $dbUsername = //enter your database user here; 
    $dbPassword =  //enter your user's password here;
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navLinks">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="register.php" tabindex="-1" >Register <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="container">
            <form action="register.php" method="post" class="regForm">
                <div class="form-group">
                    ...
                    <input type="email" name="emailAddress" id="emailAddress" class="form-control" placeholder="you@email.com" autofocus required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phoneNumber" id="phoneNumber" class="form-control" placeholder="(555) 123-4567" required>
                </div>

                <div class="form-group">
                    <label for="address1">Street Address</label>
                    <input type="text" name="address1" id="address1" class="form-control" placeholder="123 Main Street" required>
                </div>
