    ...
    <div class="container">
        <form class="col-md-6 m-auto" action="customerProfile.php" method="post" autocomplete="off">
            <div class="form-group">
                ...
                <input type="email" name="emailAddress" id="emailAddress" class="form-control" value="<?php echo $emailAddress; ?>" required>
            </div>

            <div class="form-group">
                <label for="password">Password</label>
                <input type="password" name="password" id="password" class="form-control" placeholder="Enter your password to process changes" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" name="phoneNumber" id="phoneNumber" class="form-control" value="<?php echo $phoneNumber; ?>" required>
            </div>

            <div class="form-group">
                <label for="address1">Street Address</label>
                <input type="text" name="address1" id="address1" class="form-control" value="<?php echo $address1; ?>" required>
            </div>

            <div class="form-group">
                <label for="address2">Unit/Apt Number</label>
                <input type="text" name="address2" id="address2" class="form-control" placeholder="Unit #4A" value="<?php echo $address2; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="zip" id="zip" class="form-control" value="<?php echo $zip; ?>" required>
            </div>
